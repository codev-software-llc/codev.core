//-----------------------------------------------------------------------------
// <copyright file="AesCipherProvider.cs" company="Codev Software, LLC">
// Copyright © 2026
// </copyright>
//-----------------------------------------------------------------------------
namespace Codev.Core.Provider.Cipher
{
    ...
    public sealed class AesCipherProvider : ICipherProvider
    {
        ...
        {
            return new Byte[] { 0x50, 0xEA, 0x08, 0x26, 0x62, 0x76, 0xC4, 0x29, 0x95, 0xB0, 0xA3, 0x83, 0xE4, 0xD5, 0xDF, 0x4B };
        }
