...
namespace Codev.Core.Provider.Banking.Stripe
{
    ...
    ///------------------------------------------------------------------------
    /// <summary>
    /// This class contains extensions for converting to tokens.
    /// </summary>
    ///------------------------------------------------------------------------
    public static class TokenExtensions
    {
        ...
        public static Token ToToken(
            this CreatePlanResponse response)
        {
            return new Token()
                {
                    Id          = response.Id,
        ...
        ///------------------------------------------------------------------------
        /// <summary>
        /// Return a token for a subscription.
        /// </summary>
        ///------------------------------------------------------------------------
        public static Token ToToken(
        ...
        ///------------------------------------------------------------------------
        public static Token ToToken(
            this UpdatePlanResponse response)
        {
            return new Token()
                {
                    Id          = response.Id,
        ...
        ///------------------------------------------------------------------------
        /// <summary>
        /// Return a token for a customer response
        /// </summary>
        ///------------------------------------------------------------------------
        public static Token ToToken(
            this CreateCustomerResponse response)
        {
            return new Token()
                {
                    Id          = response.Id,
