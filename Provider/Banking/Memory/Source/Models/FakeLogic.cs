...
namespace Codev.Core.Provider.Banking.Memory
{
    ...
    /// </summary>
    ///------------------------------------------------------------------------
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1600:ElementsMustBeDocumented", Justification = "Entity reads easier without detailed comments")]
    [SuppressMessage("StyleCop.CSharp.LayoutRules", "SA1516:ElementsMustBeSeparatedByBlankLine", Justification = "Entity reads easier without detailed comments")]
    public sealed class FakeLogic
    {
        ...
        private static void InitializeFakeCards()
        {
            ...
            FakeCards.Add(FakeCardVisaBadExpired, new FakeCard() { CardNumber = FakeCardVisaBadExpired, CardCode = "456", CardHolder = "Ayn Rand"    , DateExpiration = new LocalDate(2017, 12, 1), CardBalance = 5000.00m, ExpectedFailure = FakeFailureType.CardExpired       });
            FakeCards.Add(FakeCardVisaBadNumber , new FakeCard() { CardNumber = FakeCardVisaBadNumber , CardCode = "789", CardHolder = "Oscar Meyer" , DateExpiration = new LocalDate(2018, 12, 1), CardBalance = 5000.00m, ExpectedFailure = FakeFailureType.InvalidCardNumber });
        }
