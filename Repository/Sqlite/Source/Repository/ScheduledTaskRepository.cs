    ...
    public class ScheduledTaskRepository : BaseRepository, IScheduledTaskRepository
    {
            ...
            ScheduledTaskEntity entity)
        {
            ...
            SqliteAccess.CallStatement(
                "INSERT INTO [ScheduledTasks] ([IsActive], [Flags], [DateCreated], [DateModified], [IdentityId], [AttentionAt], [Priority], [Category], [DetailType], [Detail]) VALUES (1, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                this.DataSource,
                (command) =>
                    {                    
            ...
            ScheduledTaskEntity entity)
        {
            ...
            SqliteAccess.CallStatement(
                "UPDATE [ScheduledTasks] SET [IsActive] = 0 WHERE [RowId] = ?",
                this.DataSource,
                (command) =>
                    {
            ...
            ScheduledTaskEntity entity)
        {
            ...
            SqliteAccess.CallStatement(
                "DELETE FROM [ScheduledTasks] WHERE [RowId] = ?",
                this.DataSource,
                (command) =>
                    {
                        command.AddInputParameter<Int32>("RowId", entity.Id);
        ...
        public EntityCollection<ScheduledTaskEntity> GetAll()
        {
            ...
            SqliteAccess.CallStatement(
                "SELECT [RowId], [RowVersion], [IsActive], [Flags], [DateCreated], [DateModified], [IdentityId], [AttentionAt], [Priority], [Category], [DetailType], [Detail] FROM [ScheduledTasks]",
                this.DataSource,
                (command) =>
                    {
                    },
            ...
            Int32 entityId)
        {
            ...
            SqliteAccess.CallStatement(
                "SELECT [RowId], [RowVersion], [IsActive], [Flags], [DateCreated], [DateModified], [IdentityId], [AttentionAt], [Priority], [Category], [DetailType], [Detail] FROM [ScheduledTasks] WHERE [RowId] = ?",
                this.DataSource,
                (command) =>
                    {
            ...
            ScheduledTaskEntity entity)
        {
            ...
            SqliteAccess.CallStatement(
                "UPDATE [ScheduledTasks] SET [Flags] = ?, [DateCreated] = ?, [DateModified] = ?, [IdentityId] = ?, [AttentionAt] = ?, [Priority] = ?, [Category] = ?, [DetailType] = ?, [Detail] = ? WHERE [RowId] = ?",
                this.DataSource,
                (command) =>
                    {
                        command.AddInputParameter<ScheduledTaskFlags>       ("Flags"       , entity.Flags       );
        ...
        ///--------------------------------------------------------------------
        /// <summary>
        /// Return the scheduled task by the identity.
        /// </summary>
        ///--------------------------------------------------------------------
            ...
            IdentityEntity identity)
        {
            ...
            SqliteAccess.CallStatement(
                "SELECT [RowId], [RowVersion], [IsActive], [Flags], [DateCreated], [DateModified], [IdentityId], [AttentionAt], [Priority], [Category], [DetailType], [Detail] FROM [ScheduledTasks] WHERE [IdentityId] = ?",
                this.DataSource,
                (command) =>
                    {
